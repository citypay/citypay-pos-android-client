...
public class TransactionResult {
  ...
  public boolean equals(Object o) {
    ...
    return (this.additionalData == null ? transactionResult.additionalData == null : this.additionalData.equals(transactionResult.additionalData)) &&
        (this.auxiliaryData == null ? transactionResult.auxiliaryData == null : this.auxiliaryData.equals(transactionResult.auxiliaryData)) &&
        (this.cardType == null ? transactionResult.cardType == null : this.cardType.equals(transactionResult.cardType)) &&
        (this.completedAt == null ? transactionResult.completedAt == null : this.completedAt.equals(transactionResult.completedAt)) &&
        (this.createdAt == null ? transactionResult.createdAt == null : this.createdAt.equals(transactionResult.createdAt)) &&
        (this.currencySymbol == null ? transactionResult.currencySymbol == null : this.currencySymbol.equals(transactionResult.currencySymbol)) &&
        (this.customerReceipt == null ? transactionResult.customerReceipt == null : this.customerReceipt.equals(transactionResult.customerReceipt)) &&
        (this.declinedByCard == null ? transactionResult.declinedByCard == null : this.declinedByCard.equals(transactionResult.declinedByCard)) &&
        (this.emvAppCryptogram == null ? transactionResult.emvAppCryptogram == null : this.emvAppCryptogram.equals(transactionResult.emvAppCryptogram)) &&
        (this.emvAppExpirationDate == null ? transactionResult.emvAppExpirationDate == null : this.emvAppExpirationDate.equals(transactionResult.emvAppExpirationDate)) &&
        (this.emvAppTxnCounter == null ? transactionResult.emvAppTxnCounter == null : this.emvAppTxnCounter.equals(transactionResult.emvAppTxnCounter)) &&
        (this.emvAuthorizedAmount == null ? transactionResult.emvAuthorizedAmount == null : this.emvAuthorizedAmount.equals(transactionResult.emvAuthorizedAmount)) &&
        (this.emvCardholderVerificationResults == null ? transactionResult.emvCardholderVerificationResults == null : this.emvCardholderVerificationResults.equals(transactionResult.emvCardholderVerificationResults)) &&
        (this.emvCountryCode == null ? transactionResult.emvCountryCode == null : this.emvCountryCode.equals(transactionResult.emvCountryCode)) &&
        (this.emvCryptogramInfoData == null ? transactionResult.emvCryptogramInfoData == null : this.emvCryptogramInfoData.equals(transactionResult.emvCryptogramInfoData)) &&
        (this.emvIccAppid == null ? transactionResult.emvIccAppid == null : this.emvIccAppid.equals(transactionResult.emvIccAppid)) &&
        (this.emvInterchangeProfile == null ? transactionResult.emvInterchangeProfile == null : this.emvInterchangeProfile.equals(transactionResult.emvInterchangeProfile)) &&
        (this.emvIssuerAppData == null ? transactionResult.emvIssuerAppData == null : this.emvIssuerAppData.equals(transactionResult.emvIssuerAppData)) &&
        (this.emvPanSeqNum == null ? transactionResult.emvPanSeqNum == null : this.emvPanSeqNum.equals(transactionResult.emvPanSeqNum)) &&
        (this.emvTerminalCapabilities == null ? transactionResult.emvTerminalCapabilities == null : this.emvTerminalCapabilities.equals(transactionResult.emvTerminalCapabilities)) &&
        (this.emvTerminalType == null ? transactionResult.emvTerminalType == null : this.emvTerminalType.equals(transactionResult.emvTerminalType)) &&
        (this.emvTerminalVerificationResults == null ? transactionResult.emvTerminalVerificationResults == null : this.emvTerminalVerificationResults.equals(transactionResult.emvTerminalVerificationResults)) &&
        (this.emvTrack2Equivalent == null ? transactionResult.emvTrack2Equivalent == null : this.emvTrack2Equivalent.equals(transactionResult.emvTrack2Equivalent)) &&
        (this.emvTxnCurrencyCode == null ? transactionResult.emvTxnCurrencyCode == null : this.emvTxnCurrencyCode.equals(transactionResult.emvTxnCurrencyCode)) &&
        (this.emvTxnDate == null ? transactionResult.emvTxnDate == null : this.emvTxnDate.equals(transactionResult.emvTxnDate)) &&
        (this.emvTxnStatusInfo == null ? transactionResult.emvTxnStatusInfo == null : this.emvTxnStatusInfo.equals(transactionResult.emvTxnStatusInfo)) &&
        (this.emvTxnType == null ? transactionResult.emvTxnType == null : this.emvTxnType.equals(transactionResult.emvTxnType)) &&
        (this.emvTxnUnpredictableNumber == null ? transactionResult.emvTxnUnpredictableNumber == null : this.emvTxnUnpredictableNumber.equals(transactionResult.emvTxnUnpredictableNumber)) &&
        (this.isCommercialCard == null ? transactionResult.isCommercialCard == null : this.isCommercialCard.equals(transactionResult.isCommercialCard)) &&
        (this.isContactless == null ? transactionResult.isContactless == null : this.isContactless.equals(transactionResult.isContactless)) &&
        (this.isFallback == null ? transactionResult.isFallback == null : this.isFallback.equals(transactionResult.isFallback)) &&
        (this.isOffline == null ? transactionResult.isOffline == null : this.isOffline.equals(transactionResult.isOffline)) &&
        (this.isVoided == null ? transactionResult.isVoided == null : this.isVoided.equals(transactionResult.isVoided)) &&
        (this.merchantReceipt == null ? transactionResult.merchantReceipt == null : this.merchantReceipt.equals(transactionResult.merchantReceipt)) &&
        (this.responseCode == null ? transactionResult.responseCode == null : this.responseCode.equals(transactionResult.responseCode)) &&
        (this.responseText == null ? transactionResult.responseText == null : this.responseText.equals(transactionResult.responseText)) &&
        (this.result == null ? transactionResult.result == null : this.result.equals(transactionResult.result)) &&
        (this.scheme == null ? transactionResult.scheme == null : this.scheme.equals(transactionResult.scheme)) &&
        (this.signatureRequired == null ? transactionResult.signatureRequired == null : this.signatureRequired.equals(transactionResult.signatureRequired)) &&
        (this.terminalId == null ? transactionResult.terminalId == null : this.terminalId.equals(transactionResult.terminalId)) &&
        (this.totalAmount == null ? transactionResult.totalAmount == null : this.totalAmount.equals(transactionResult.totalAmount)) &&
        (this.transactionType == null ? transactionResult.transactionType == null : this.transactionType.equals(transactionResult.transactionType)) &&
        (this.verifiedByPin == null ? transactionResult.verifiedByPin == null : this.verifiedByPin.equals(transactionResult.verifiedByPin));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.customerReceipt == null ? 0: this.customerReceipt.hashCode());
    ...
    result = 31 * result + (this.merchantReceipt == null ? 0: this.merchantReceipt.hashCode());
